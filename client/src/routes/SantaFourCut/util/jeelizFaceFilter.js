...
var JEELIZFACEFILTER = (function () {
  window.JEELIZFACEFILTERGEN = function () {
    ...
    function ub(a) {
      ...
      a =
        'undefined' === typeof btoa
          ...
          : atob(a);
      for (var c = a.length, d = new Uint8Array(c), f = 0; f < c; ++f)
        d[f] = a.charCodeAt(f);
      return d;
    }
    function gb(a) {
      ...
      if ('undefined' === typeof gb(a).nb) {
        ...
        for (
          ...
          var n = q * k,
            ...
            y = tb(c, n + 1, a);
          n = n + 1 + a;
          for (var D = l.length, z = 0, I = n; I < n + D; ++I)
            (l[z] = fb(c, I, !0)), ++z;
          for (D = n = 0; D < d; ++D) n += l[D] * Math.pow(2, -D - 1);
          m[k] =
            0 === n && 0 === y
              ? 0
              : r * (1 + n) * Math.pow(2, 1 + y - Math.pow(2, a - 1));
        }
        a = m;
    ...
    function Nb() {
      ...
      U.xa.g(0);
      P.l(!1, !1);
      return ba.enableAsyncReadPixels
        ? Z.Hb(0, 0, 3, 2 * a, U.buffer, xb, 1)
        : Z.Wd(0, 0, 3, 2 * a, U.buffer);
    }
    function vb() {
      na !== ia.pause &&
    ...
    function xb() {
      va.ig();
      ba.isCleanGLStateAtEachIteration &&
        (va.reset(), X.reset(), b.enable(b.DEPTH_TEST));
      R.Qb && R.Qb(da.Hd() ? Ba : Ba[0]);
      ba.isCleanGLStateAtEachIteration &&
        (b.disable(b.BLEND), P.reset(), P.za());
    }
    function Pb() {
      for (var a = 0; a < da.ra(); ++a)
        if (da.zf(a)) {
          ...
          if (d.hb < ba.multiDetectionThresholdFactors[0] * ba.threshold)
            ...
            m.rz = R.Aa
              ? m.rz + ra.followZRotAlphaFactor * l * d.wa
              : wa.Z(m.rz, d.wa, l);
            ...
            l = Math.max(l, ea.qe);
            for (c = 0; c < U.$; ++c)
              m.expressions[c] = wa.Z(m.expressions[c], d.nd[c], l);
            ++d.ua;
          }
        }
    }
    ...
    function yb() {
      ...
      var a = {
        ...
        isPot: !1,
        array: da.Le(
          new Float32Array([0, 0.5, 0.5, 0, 0, 0, 0, 0, 0, 0, 0, 0]),
        ),
      };
      U.xa = Rb.instance(a);
    }
    function lb() {
      ...
      H.U('s61', [
        ...
        { type: '1f', name: 'u48', value: ba.threshold },
        {
          type: '3f',
          name: 'u46',
          value: [U.M[0] * aa.D[0], U.M[1] * aa.D[1], U.M[2]],
        },
        { type: '1f', name: 'u41', value: 0.5 },
    ...
    function Ub() {
      ...
      da.Hd() &&
        (f && ((d = 0), (Sa[a].ua = 0), (c.isDetected = !1), (c.detected = 0)),
        H.F('u49', d));
      H.Yf('u45', Ta.get(a));
      P.l(!1, !1);
      if (da.Gd() || f)
        b.viewport(1, a, 1, 1), H.set('s62'), H.F('u49', d), P.l(!1, !1);
    ...
    function Bb() {
      var a = {
        w: L.element.videoWidth || L.element.width,
        Ca: L.element.videoHeight || L.element.height,
      };
      if (!a.w || !a.Ca || 4 > a.w || 4 > a.Ca)
        throw Error(
          'INVALID VIDEO DIMENSIONS - width = ' + a.w + ' height = ' + a.Ca,
        );
      return a;
    }
    function nb() {
      ...
      ab = {
        get: function (a, c, d) {
          ...
          f.onreadystatechange = function () {
            4 === f.readyState &&
              (200 === f.status || 0 === f.status
                ? c(f.responseText)
                : 'undefined' !== typeof d && d(f.status));
          };
          f.send();
        },
        hf: function (a) {
        ...
        var l = null,
          ...
          I = {
            ...
            gh: function () {
              ...
              for (
                var x = I.We(),
                  G = k.createImageData(q.width, q.height),
                  e = q.width,
                  A = q.height,
                  B = G.data,
                  g = 0;
            ...
            v: function (x) {
              ...
              if (b) r = b instanceof WebGL2RenderingContext;
                ...
                b
                  ? (r = !0)
                  : ((b = l.getContext('webgl', G)) ||
                      (b = l.getContext('experimental-webgl', G)),
                    (r = !1));
              }
      ...
      Aa = (function () {
        ...
        var q = 0,
          ...
          p = {
            ...
            mf: function () {
              if (!y) {
                for (var h = new Float32Array(16384), J = 0; 16384 > J; ++J)
                  h[J] = 2 * Math.random() - 1;
                y = {
                  random: p.instance({
                    isFloat: !0,
            ...
            instance: function (h) {
              ...
              function O(K) {
                ...
                Q !== b.NO_ERROR &&
                  fa !== b.RGBA &&
                  ((fa = b.RGBA), b.texImage2D(b.TEXTURE_2D, 0, ja, fa, ha, K));
                return !0;
              }
              function Y() {
                if (!Db) {
                  ...
                  E.isPot
                    ? (b.texParameteri(
                      ...
                      b.texParameteri(
                        b.TEXTURE_2D,
                        b.TEXTURE_WRAP_T,
                        E.isMirrorY ? b.MIRRORED_REPEAT : b.REPEAT,
                      ))
                    : (b.texParameteri(
                        b.TEXTURE_2D,
                        b.TEXTURE_WRAP_S,
                  ...
                  E.isAnisotropicFiltering &&
                    ...
                    b.texParameterf(
                      b.TEXTURE_2D,
                      JEContext.hh().TEXTURE_MAX_ANISOTROPY_EXT,
                      JESETTINGS.og,
                    );
                  b.texParameteri(
                    b.TEXTURE_2D,
                    b.TEXTURE_MAG_FILTER,
                    E.isLinear ? b.LINEAR : b.NEAREST,
                  );
                  E.isLinear
                    ? b.texParameteri(
                        b.TEXTURE_2D,
              ...
              var ca = {
                ...
                Se: function (K) {
                  ...
                  if (La) {
                    ...
                    K !== Hb &&
                      ((Hb = K),
                      b.TEXTURE_MAX_LEVEL &&
                        b.texParameteri(b.TEXTURE_2D, b.TEXTURE_MAX_LEVEL, K)),
                      ca.bc();
                },
                Wh: function (K) {
                ...
                cd: function (K) {
                  ...
                  if (K)
                    b.viewport(0, 0, S, T),
                      H.Zf('u11', 0.25, 0.25, 0.25, 0.25),
                      ma.l(!1, !0);
                  else
                    for (K = 0; 4 > K; ++K)
                      b.viewport(0, T * K, S, T),
                        H.de('u11', u[K]),
                        ma.l(!1, 0 === K);
                },
                Nb: function (K) {
                ...
                E.array
                  ? (E.P && !E.isFloat
                      ...
                      : ((ua = E.isFloat
                        ...
                        Y()),
                    E.isKeepArray ||
                      (ua && ua !== E.array && (ua = null), delete E.array))
                  : E.ec
                  ? (Ua = !0)
                  : Y();
              ca.rh = ca.I;
        ...
        var c = null,
          ...
          k = {
            ...
            instance: function (n) {
              ...
              b.bufferData(
                b.ARRAY_BUFFER,
                n.ba instanceof Float32Array ? n.ba : new Float32Array(n.ba),
                D,
              );
              l = r;
              var I = null,
            ...
            za: function () {
              ...
              -1 !== q &&
                (b.bindBuffer(b.ELEMENT_ARRAY_BUFFER, c.indices), (q = -1));
            },
            l: function (n, r) {
              n && ma.za();
              r && xa.Ha();
          ...
          q = {
            ...
            v: function () {
              if (!f) {
                ...
                var k = Z.la();
                c =
                  k && b.DRAW_FRAMEBUFFER ? b.DRAW_FRAMEBUFFER : b.FRAMEBUFFER;
                d =
                  k && b.READ_FRAMEBUFFER ? b.READ_FRAMEBUFFER : b.FRAMEBUFFER;
                f = !0;
              }
            },
            ih: function () {
      ...
      Z = (function () {
        ...
        function f(g) {
          if (0 === e.sa.length) {
            ...
            e.sa.splice(0);
            e.rb.splice(0);
            for (var F = 0; F < e.Qa; ++F)
              e.sa.push(b.createBuffer()), e.rb.push(-1);
            e.ha = 0;
            e.rc = 0;
          }
          b.bindBuffer(e.W, e.sa[e.ha]);
          g.byteLength !== e.rb[e.ha] &&
            (b.bufferData(e.W, g.byteLength, b.STREAM_READ),
            (e.rb[e.ha] = g.byteLength));
          e.xh = !0;
        }
        function m() {
          ...
          B = {
            v: function () {
              ...
              if (!y.Cd) {
                ...
                if (y.Fd || B.la())
                  (y.Lc = B.md(g)), (A.GL_EXT_HALFFLOATLINEAR = y.Lc);
                y.yh = y.Lc ? !0 : !1;
                y.Cd = !0;
              }
              y.Rb = B.hd(g);
            ...
            cc: function (g) {
              var F = B.kb(g);
              return F && F.HALF_FLOAT_OES
                ? F.HALF_FLOAT_OES
                : g.HALF_FLOAT || g.FLOAT;
            },
            Ye: function () {
            ...
            Kb: function (g, F, u) {
              ...
              if (
                g.checkFramebufferStatus(
                  g.READ_FRAMEBUFFER || g.FRAMEBUFFER,
              ...
              v();
              for (u = 0; 36 > u; ++u)
                if (3 !== u % 4 && 3 < Math.abs(F[u] - 127)) return !1;
              return !0;
            },
            Ub: function (g) {
              var F = { ia: !1, ka: !1 };
            ...
            Ie: function () {
              ...
              F.o();
              B.flush();
              b.checkFramebufferStatus(la.af()) !== b.FRAMEBUFFER_COMPLETE
                ? (Aa.Uf(), (z.ac = !1))
                : (z.ac = !0);
              g.remove();
              F.remove();
      ...
      Ca = (function () {
        function a(u, v, C, M) {
          e.texParameteri(
            ...
            M ? e.NEAREST_MIPMAP_NEAREST : e.LINEAR,
          );
          var w = null;
          if (null !== C)
            try {
        ...
        function c(u, v) {
          return A.ia && a(u, e.FLOAT, new Float32Array(D), v)
            ? ((k = q.Tc), !0)
            : !1;
        }
        function d(u, v, C) {
          ...
          var M = Aa.De(D),
            w = Z.kb(e);
          if (
            (w && w.HALF_FLOAT_OES && a(u, w.HALF_FLOAT_OES, M, v)) ||
            (e.HALF_FLOAT && a(u, e.HALF_FLOAT, M, v))
          )
            return (k = q.La), !0;
      ...
      Lb = (function () {
        return {
          instance: function (a) {
            ...
            a.vf
              ? ((a.sparsity =
                  'undefined' !== typeof a.sparsity ? a.sparsity : a.Fb.dc()),
                (n = !1))
            ...
            return {
              ...
              R: function (f) {
                if (f.isEnabled) {
                  ...
                  f.Bf.g(3);
                  for (
                    var m = Math.min(f.zb.length, f.depth), l = 0;
                    l < m;
                    ++l
                  )
                    f.zb[l].ue(4 + l);
      ...
      ac = (function () {
        return {
          instance: function (a) {
            ...
            var d = Object.assign(
                { na: 0.1, ea: 9, u: 128, gain: 1, zc: 0, Wa: !1, X: !1 },
                a,
              ),
              f = c(!1),
              m = null,
            ...
            if (a.video.width.ideal && a.video.height.ideal) {
              ...
              for (k.pa = void 0; n < l.length; k = { pa: k.pa }, ++n) {
                ...
                for (r.oa = void 0; y < q.length; r = { oa: r.oa }, ++y)
                  if (
                    ((r.oa = q[y]),
                    k.pa !== a.video.width.ideal ||
                      r.oa !== a.video.height.ideal)
                  ) {
            ...
            : new Promise(function (f, m) {
                if (a.srcObject && a.srcObject.getVideoTracks) {
                  ...
                  1 !== l.length
                    ...
                    : ((l = l[0]), c ? V.get(a, f, m, d) : (l.stop(), f()));
      ...
      qa = (function () {
        ...
        var c = {
          ...
          x = {
            ...
            bh: function (G) {
              return Math.pow(
                Math.min(Math.max(k, 0), f.n - 1) / (f.n - 1),
                G || 1,
              );
            },
            v: function (G) {
      ...
      Na = (function () {
        ...
        function y(w) {
          var t = u.ja,
            ...
            h = u.tb;
          h = u.Fa
            ? p.Zg(h, p.QUERY_RESULT_AVAILABLE_EXT)
            : t.getQueryParameter(h, t.QUERY_RESULT_AVAILABLE);
            ...
            y(function (p) {
              if (p) {
                ...
                var h = u.sb,
                  J = u.tb;
                p = u.Fa
                  ? h.getQueryObjectEXT(J, h.QUERY_RESULT_EXT)
                  : p.getQueryParameter(J, p.QUERY_RESULT);
                w(p);
              } else t();
            });
          });
        ...
        return {
          v: function (D) {
            ...
            for (var A = 0; A < d.Od; ++A) {
              ...
              u /= 2;
              for (
                var M = 1 + (1 - F - F) / v, w = 1 + (1 - u - u) / C, t = 0;
                t < w;
                ++t
              )
          ...
          reset: function () {
            for (var D = f.length / q.length, z = 0; z < q.length; ++z)
              q[z] = Math.floor(z * D);
            r = 0;
            n = f;
          },
      ...
      da = (function () {
        ...
        var q = { L: 1, Ld: 0.3, ed: [1, 1], Ne: 6, $d: 0.3, Ad: null, wf: !0 },
          ...
          G = {
            ...
            Le: function (e) {
              for (
                var A = new Float32Array(e.length * k.L), B = 0, g;
                B < k.L;
                ++B
              )
      ...
      sb = {
        ...
        init: function (a) {
          ...
          'undefined' !== typeof a.maxFacesDetected &&
            (d = Math.max(1, a.maxFacesDetected));
          ...
          da.v({
            ...
            Ad: function (m) {
              return (
                m.detected > ba.multiDetectionThresholdFactors[1] * ba.threshold
              );
            },
          });
          for (d = 0; d < da.ra(); ++d)
            jb.push(new Float32Array(ea.Gf)), kb.push(0);
        ...
        toggle_videoStream: function (a) {
          return L.ub || !L.element
            ? Promise.resolve()
            : V.ke(L.element, a, L.Pa);
        },
          ...
          Za() &&
            ...
            (a && !R.wb
              ? ((R.Sd = R.ca),
                ...
                this.set_animateDelay(ea.ng),
                (R.wb = !0))
              : !a &&
                R.wb &&
                ((ba.nDetectsPerLoop = -1),
                this.set_animateDelay(R.Sd),
                (R.wb = !1)));
        },
