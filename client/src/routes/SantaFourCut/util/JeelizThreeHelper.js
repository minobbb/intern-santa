...
const JeelizThreeHelper = (function () {
  ...
  function create_videoScreen() {
    ...
    if (_isSeparateThreeCanvas) {
      ...
      const samplerVideo = _gl.getUniformLocation(
        _glShpCopyCut,
        'samplerVideo',
      );
      _glShpCopyCutVideoMatUniformPointer = _gl.getUniformLocation(
        _glShpCopyCut,
        'videoTransformMat2',
      );
    ...
    const setVideoGeomAttribute = (
      videoGeometry.setAttribute || videoGeometry.addAttribute
    ).bind(videoGeometry);
    setVideoGeomAttribute(
      'position',
  ...
  const that = {
    ...
    render: function (detectState, threeCamera) {
      ...
      if (_isSeparateThreeCanvas) {
        ...
        _gl.uniformMatrix2fv(
          _glShpCopyCutVideoMatUniformPointer,
          false,
          _videoTransformMat2,
        );
    ...
    apply_videoTexture: function (threeMesh) {
      ...
      threeMesh.onAfterRender = function () {
        ...
        try {
          ...
          console.log(
            'WARNING in JeelizThreeHelper: the glVideoTexture is not fully initialized',
          );
        }
    ...
    update_camera: function (threeCamera) {
      ...
      console.log(
        'INFO in JeelizThreeHelper - update_camera(): Estimated vertical video FoV is',
        fov,
      );
      ...
      threeCamera.fov = fov;
      console.log(
        'INFO in JeelizThreeHelper.update_camera(): camera vertical estimated FoV is',
        fov,
        'deg',
      );
